<?php
    ...
    if (isset($_POST['save_book'])) {
        ...
        $query = "INSERT INTO `books`(`book_name`, `book_image`, `book_author_name`, `book_publication_name`, `book_price`, `book_qty`, `available_qty`, `librarian_email`) VALUES('$book_name', '$image', '$book_author_name', '$book_publication_name', '$book_price', '$book_qty', '$available_qty', '$librarian_email')";
